...
> ⚠ **Superseded 26 September for tiers, prices and who can run a game.** The owner's
> decision, and rev 18 `01-product-logic.md` § 4 (12 Aug revision), are final:
> **Free** (tonight, and the last three games) · **Regular $2.49/mo** (every night in the book,
> missed nights included, one host night a month, renewing each billing period) ·
> **Full $9.99/mo** (runs games any night). **Free can never run a game.** Passing a running game
> to another phone is available to whoever admins it, on any tier, and the receiver must be Full
...
| 2 | **What's free** | ~~The night itself.~~ **Superseded:** Free watches tonight and sees the last three games; it cannot run a game. |
...
| 4 | **Tiers** | ~~Watcher · Player · Host Free · Host Pro · Club.~~ **Superseded:** Free · Regular · Full, on the person, not the group. Share-link watchers stay free with no account. |
| 5 | **Price** | ~~$4.99/mo Host Pro, $9.99 Book Pass, $69/yr Club.~~ **Superseded:** Regular $2.49/mo, Full $9.99/mo. |
...
> ⚠ **Superseded** — see the banner at the top. Current table:
>
> | | **Free** | **Regular** | **Full** |
> |---|---|---|---|
> | Price | $0 | $2.49 / mo | $9.99 / mo |
> | Watch tonight live | ✅ | ✅ | ✅ |
> | History | last three games | every night, missed ones included | every night |
> | Open a game | — | one host night a month (renews) | any night |
> | Receive a passed game | — | if this month's host night is free | ✅ |
> | Pass a game you admin | — | ✅ | ✅ |
> | Count, settle, close the night you admin | — | ✅ identical | ✅ identical |
> | Edit the group | — | — | ✅ |

Original table, kept as background:
