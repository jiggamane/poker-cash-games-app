...
Foot on both tabs: **End the night** ("count & settle"), then **Buy-in** (primary) and **Cash out** (secondary).
...
**N6 · Rebuy · amount.** Same, with `REBUY · 3RD` and "already in for $1,500". Presets: standard (STANDARD), ×2, ×4, Custom. Primary **Log the rebuy**.
