...
**`CHANGELOG.md` — delta since the last bundle (12 Aug 2026).** Read it before anything else: it names which sections of the docs below are superseded, and carries the answers to the open money-rule questions.
