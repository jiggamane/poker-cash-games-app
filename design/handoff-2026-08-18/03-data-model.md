...
displayName
role              'host' | 'player'
paysPiggy bank         boolean, group-level default
...
groupId
name
kind              'bill' | 'piggy bank' | 'host_fee' | 'next_pot'
...
carriedBalance    minor units, piggy bank only
...
piggy bankOptOuts      [memberId] — tonight only
createdBy
```
