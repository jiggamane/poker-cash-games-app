...
- [ ] Piggy bank at 5%: 81 / 23 / 22, total 126. Lena's 21.5 rounds up.
...
- [ ] Settlement produces exactly six transfers, in the drawn order and amounts (Petr→Dana 1,230 · Ivo→Marek 500 · Ivo→Lena 280 · Tomáš→Dana 252 · Tomáš→Lena 122 · Tomáš→piggy bank 126).
...
- [ ] Switch someone off the piggy bank at 23:26 and see it in the settle-up, with nothing logged changing.
...
- [ ] Write the difference off to the piggy bank and confirm a ledger entry is created.
