...
- The entries list gains a **Cashed out** row — "stack counted · seat closed" — with the counted amount, and beneath a 1px top rule a `400 13px/1.5` muted line: "Her result is set. Bills and the piggy bank still come off it at settle-up."
