...
| --- | --- | --- |
| **Club default** | Currency, default buy-in, bill split, rounding, kitty charge, who collects, who pays in. Set once. | GR7 Settings, GR8 Money rules |
...
- **Nothing on a bill or kitty screen computes a share while a night is running** — see
  `11-bill-and-kitty.md`. The rules are what the club and the night carry; the arithmetic runs once, at
  settle-up.
...
2. The setup shows the inherited rules as a **summary, not a form**: buy-in, bill split, kitty. One row
...
| GR5 | Player · edit | Sheet over the roster | Name, standing, **App → Invite**, kitty switch, their nights, Remove (red outline). |
...
| GR8 | Money rules | Push from Settings | Club defaults for bill and kitty. Deepest route in the section — two pushes below root. |
