...
One money question is still open: on E5, confirm that writing the difference off to the kitty creates a real ledger entry rather than a silent adjustment. The bill-reimbursement model is settled — each fronter is paid back what they fronted — and the screens are drawn that way.
...
- Kitty membership: group default and tonight-only [C6, O7, B6]
