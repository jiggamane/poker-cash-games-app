 ...
 * doc 15 § 4 — how tall each of the 24 sheets ends up on an SE, a mini, the
...
const ROUTES = [
  ...
  '/rounding', '/share', '/auth-callback', '/end-time', '/pass-book', '/take-over',
];
 ...
 */
const KEYPAD = ['/log', '/spend', '/share', '/end-time'];
  ...
  for (const route of routes) {
    for (const scheme of ['dark', 'light']) {
      ...
      try {
         ...
         * and `Signed in as unknown` is exactly the string B91 was about.
         */
        if (route === '/settings') {
          ...
          if (account === null || account === '') {
            ...
            findings.push({
              ...
              detail: `Settings says “${account}” about an account it cannot name — B91`,
              where: route,
            });
          }
        }
