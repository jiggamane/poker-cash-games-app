 ...
 *
 *   FINAL, DETAILED  the settled net over the poker result and every spend
 *                    itemised. Default, and the one view that does not draw
 *                    the two stacks — see `GameTerm` in `SessionViews.tsx`.
