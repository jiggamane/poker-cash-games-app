...
export function Screen({
   ...
   * been drawn with it — the step count in the ending flow, "1 of 3". The
   * corner takes no controls: that rule is what keeps a push and a sheet
   * telling different stories.
   *
   * NOT alongside a badge. A badge and a trailing text pull at opposite ends
   * of the row and leave the title, the one child that shrinks, to absorb what
   * is left; on Tonight that broke "Tonight" mid-word. If a screen wants both,
   * one of them belongs somewhere else — `docs/tonight-title-row.md` has the
   * arithmetic and what was done about it.
   */
  trailing?: ReactNode;
